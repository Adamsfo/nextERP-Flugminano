...
const TextInputFieldReais: React.FC<TextInputFieldReaisProps> = ({
  name,
  placeholder,
  value,
  onChange,
  ...
  return (
    <CFormFloating className="mb-3">
      <CFormInput
        ...
        name={name}
        placeholder=" "
        value={formatCurrency(String(value))} // Exibe o valor formatado
...
export default TextInputFieldReais
