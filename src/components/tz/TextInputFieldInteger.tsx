...
interface TextInputFieldIntegerProps {
  name: string
  placeholder: string
  value: string | number
...
const TextInputFieldInteger: React.FC<TextInputFieldIntegerProps> = ({
  name,
  placeholder,
  value,
  onChange,
  ...
  return (
    <CFormFloating className="mb-3">
      <CFormInput
        ...
        name={name}
        placeholder=" "
        value={formatInteger(String(value))} // Exibe o valor formatado
...
export default TextInputFieldInteger
