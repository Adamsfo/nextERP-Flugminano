...
type Registro = Matriz

export default function MatrizForm({ params }: { params: FormPropsEdit }) {
  ...
  return (
    <PermissionGate permission={2}>
      <CForm onSubmit={handleSubmit}>
        <CCard>
          <CCardHeader>
            <strong>{params.id ? 'Alterando matriz' : 'Cadastrando matriz'}</strong>
          </CCardHeader>
          <CCardBody>
            <CRow>
              <CCol md={1}>
