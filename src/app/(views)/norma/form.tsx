...
import { ClienteFornecedor, EnderecoClienteFornecedor, FormPropsEdit, Norma } from '@/types/geral'
...
export default function NormaForm({ params }: { params: FormPropsEdit }) {
