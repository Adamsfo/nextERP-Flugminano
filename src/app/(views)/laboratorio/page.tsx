...
const Page = () => {
  ...
  const columns = [
    ...
    { key: 'nome', _style: { minWidth: '100px' }, label: 'Nome' },
    { key: 'responsavelTecnico', _style: { minWidth: '100px' }, label: 'Responsável Técnico' },
    { key: 'registroCRQ', _style: { minWidth: '100px' }, label: 'Registro CRQ' },
    { key: 'ativo', _style: { minWidth: '100px' }, label: 'Ativo' },
